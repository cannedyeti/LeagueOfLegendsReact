...
function ultimateSpells() {
    ...
    for (var s in sums.data) {
        if(!sums.data[s].key.includes("Dark") && !sums.data[s].key.includes("Siege") && !sums.data[s].key.includes("Poro") && !sums.data[s].key.includes("Snowball") && !sums.data[s].key.includes("Mana")) {
